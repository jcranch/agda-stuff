module Sheffield.CategoryTheory-Setoid.Categories.Join where
...
infixl 6 _✫_
_✫_ : {ℓ₁ ℓ′₁ ℓ″₁ ℓ₂ ℓ′₂ ℓ″₂ : Level} (C₁ : Category {ℓ₁} {ℓ′₁} {ℓ″₁}) (C₂ : Category {ℓ₂} {ℓ′₂} {ℓ″₂}) → Category {ℓ₁ ⊔ ℓ₂} {{!!}}

_✫_ {ℓ₁} {ℓ′₁} {ℓ″₁} {ℓ₂} {ℓ′₂} {ℓ″₂} (makeCat obj₁ hom₁ id₁ compose₁ id-l₁ id-r₁ assoc₁) (makeCat obj₂ hom₂ id₂ compose₂ id-l₂ id-r₂ assoc₂) = makeCat obj hom {!!} {!!} {!!} {!!} {!!} where
  obj = obj₁ ⊎ obj₂

  hom : (x y : obj) → Setoid (ℓ′₁ ⊔ ℓ′₂) (ℓ″₁ ⊔ ℓ″₂)
