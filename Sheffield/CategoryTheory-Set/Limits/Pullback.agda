module Sheffield.CategoryTheory-Set.Limits.Pullback where
...
module pullback-context {ℓ₁ ℓ′₁ : Level} (C : Category {ℓ₁} {ℓ′₁})
  ...
  record IsPullback-lowbrow : Set (ℓ₁ ⊔ ℓ′₁) where
    constructor make-pullback 
    field
      factorisations : {x : obj} (q₁ : hom x b) (q₂ : hom x c) → (f₁ • q₁ ≡ f₂ • q₂) → existsUnique (hom x a) _≡_ (λ h → (p₁ • h ≡ q₁) × (p₂ • h ≡ q₂))
